...
abstract class AdminModules extends AbstractModules {
	...
	private function setMenu() {
		...
		$this->template->set("link_images", $this->url_admin->images());
		$this->template->set("link_videos", $this->url_admin->videos());
		$this->template->set("link_infos", $this->url_admin->infos());
		$this->template->set("link_orders", $this->url_admin->orders());
		$this->template->set("link_sections", $this->url_admin->sections());
		$this->template->set("link_comments", $this->url_admin->comments());
		$this->template->set("link_discounts", $this->url_admin->discounts());
		$this->template->set("link_models", $this->url_admin->models());
